...
/***/ "./src/generadorFaker.js":
/*!*******************************!*\
  !*** ./src/generadorFaker.js ***!
  \*******************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

eval("const faker = __webpack_require__(/*! faker */ \"faker\");\nconst { isWhiteSpaceSingleLine } = __webpack_require__(/*! typescript */ \"typescript\");\n\nfaker.locale = \"es_MX\";\n\nconst get = () => ({\n  price: faker.commerce.price(),\n  thumbnail: faker.image.imageUrl(),\n  name: faker.commerce.productName(),\n  description: faker.commerce.productDescription(),\n  stock: faker.datatype.number(100),\n  code: faker.datatype.uuid(),\n});\n\nconst generate = (quantity) => {\n  if (!quantity) return null;\n\n  let response = [];\n  while (quantity) {\n    response.push(get());\n    quantity--;\n  }\n  return response;\n};\n\nmodule.exports = {\n  get,\n  generate,\n};\n\n\n//# sourceURL=webpack://back/./src/generadorFaker.js?");
